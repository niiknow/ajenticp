...
apt-get install -yq php5.6-fpm php5.6-cgi php5.6-cli php5.6-dev php5.6-dbg php5.6-common \
...
apt-get install -yq php7.0-fpm php7.0-cgi php7.0-cli php7.0-dev php7.0-dbg php7.0-common \
