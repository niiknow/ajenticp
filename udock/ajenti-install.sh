...
apt-get update && apt-get -yq upgrade && apt-get install -yqf sudo wget git curl vim nano apt-show-versions apt-utils
...
apt-get update && apt-get install -yq mariadb-server mariadb-client libmagickwand-dev imagemagick php-dev
